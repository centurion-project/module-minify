 ...
 */
class Minify_Model_Minify_HTML {

    private $_minifyHtml = false, $_minifyJs = false, $_minifyCss = false, $_concatJs = false, $_concatCss = false;
    ...
    public static function minify($html, $options = array()) {
        $min = new Minify_Model_HTML($html, $options);
        return $min->process();
    }
